...
menu_item1 = MenuItem.find_or_create_by(name: 'Pav Bhaji', veg: true, price: 120, terminal_id: terminal.id)
menu_item2 = MenuItem.find_or_create_by(name: 'Dal Makhni', veg: true, price: 100, terminal_id: terminal.id)
menu_item3 = MenuItem.find_or_create_by(name: 'Biryani', veg: true, price: 90, terminal_id: terminal.id)

terminal1 = Terminal.find_or_create_by(name: 'Dominoes', landline: '0203030293', company_id: company.id)
menu_item4 = MenuItem.find_or_create_by(name: 'Chicken Pizza', veg: false, price: 120, terminal_id: terminal1.id)
menu_item5 = MenuItem.find_or_create_by(name: 'Stuffed garlic Bread', veg: true, price: 100, terminal_id: terminal1.id)
